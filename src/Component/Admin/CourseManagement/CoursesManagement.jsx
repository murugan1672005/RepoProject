...
const CourseManagement = () => {
  ...
  const [newCourse, setNewCourse] = useState({
    ...
    endDate: '',
    schedule: [],
    courseImageUrl: '' // Add courseImageUrl to the newCourse state
  });
  ...
  const [editCourse, setEditCourse] = useState({
    ...
    schedule: [],
    enrolled: 0,
    courseImageUrl: '' // Add courseImageUrl to the editCourse state
  });
  ...
  const handleAddCourse = () => {
    const token = localStorage.getItem('token');
    axios.post('http://localhost:5454/admin/courses/create', newCourse, {
      headers: {
        Authorization: `Bearer ${token}`,
        'Content-Type': 'application/json',
      },
      ...
      .then(response => {
        ...
        setNewCourse({
          ...
          endDate: '',
          schedule: [],
          courseImageUrl: '' // Reset courseImageUrl field
        });
